...
public class MateriaValueScaler {
    ...
    private static double QUEEN_LOGIC_FACTOR = 8.9/9;
    private static double ROOK_LOGIC_FACTOR = 1.02;
    private static double KNIGHT_LOGIC_FACTOR = 1.01;
    private static double BISHOP_LOGIC_FACTOR = 1.06667;
    private static double PAWN_LOGIC_FACTOR = 1.06667;

    private static int SCALE_FACTOR = 100;


    public static double scaleMaterialByPieceType(PieceType pieceType){
