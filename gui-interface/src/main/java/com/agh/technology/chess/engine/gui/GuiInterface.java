...
public class GuiInterface {
    ...
    public static void communicateToUCI() {
        ...
        while(true) {
            ...
            if(inputString.equals("isready")) isReady();
            else if(inputString.equals("ucinewgame")) restartGame();
            else if(inputString.startsWith("position")) setPosition(inputString);
            else if(inputString.startsWith("go")) go();
            else if(inputString.startsWith("print")) print();
